        ...
        <div className="flex justify-center">
            <div className="w-60 h-60 data bg-white shadow-md rounded-md mt-9">
                ...
                <div className="mt-8">
                    ...
                    <p><label className="text-lg font-bold">Number : </label>{props.tele}</p>
                </div>
                <div className="flex justify-center">
                    <button className="SupprimerBtn hover:from-indigo-600 hover:to-purple-600 text-white font-bold py-2 px-4 rounded-full shadow-md hover:shadow-lg w-56 flex ">
                        Supprimer
                    </button>
                </div>
                </center>
